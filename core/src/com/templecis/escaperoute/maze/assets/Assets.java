package com.templecis.escaperoute.maze.assets;
...
public class Assets {
    ...
    public static final String GRAPHICS_DIRECTORY = "assets/images";
    ...
    public static void load() {
        manager.load(GRAPHICS_DIRECTORY + "/Wall.png", TextureAtlas.class);
